...
//    NSLog(@"%@",string);b30323ace96d8762
    ...
    self.tabBarController.viewControllers = [NSArray arrayWithObjects:self.rootNavigationController,self.homeNavigationController,self.tudouNavigationController, self.mineNavigationController,nil];
    
    //imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal此方法避免系统自动渲染
    // self.homeNavigationController.tabBarItem.title = @"我的音乐";
    self.homeNavigationController.tabBarItem.image = [[UIImage imageNamed:@"ic_tabbar_music"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.homeNavigationController.tabBarItem.imageInsets= UIEdgeInsetsMake(2, 0, -2, 0);
    //self.homeNavigationController.tabBarItem.selectedImage = [[UIImage imageNamed:@"ic_tabbar_music_s"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];

    ///self.rootNavigationController.tabBarItem.title = @"发现音乐";
    self.rootNavigationController.tabBarItem.image = [[UIImage imageNamed:@"ic_tabbar_find_f"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.rootNavigationController.tabBarItem.imageInsets= UIEdgeInsetsMake(-2, 0, 2, 0);
    //self.rootNavigationController.tabBarItem.selectedImage=[[UIImage imageNamed:@""]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    //self.tudouNavigationController.tabBarItem.title = @"朋友";
    self.tudouNavigationController.tabBarItem.image = [[UIImage imageNamed:@"ic_tabbar_friend_f"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.tudouNavigationController.tabBarItem.imageInsets= UIEdgeInsetsMake(-2, 0, 2, 0);
    //self.tudouNavigationController.tabBarItem.selectedImage=[[UIImage imageNamed:@""]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];

    //self.mineNavigationController.tabBarItem.title = @"账号";
    self.mineNavigationController.tabBarItem.image = [[UIImage imageNamed:@"ic_tabbar_mine_f"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.mineNavigationController.tabBarItem.imageInsets= UIEdgeInsetsMake(-2, 0, 2, 0);
    //self.mineNavigationController.tabBarItem.selectedImage=[[UIImage imageNamed:@""]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];


    
    self.tabBarController.selectedViewController = self.rootNavigationController;
    [self.tabBarController.tabBar setBackgroundImage:[UIImage imageNamed:@"bg_tabbar"]];

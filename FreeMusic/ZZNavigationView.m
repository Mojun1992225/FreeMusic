...
@synthesize navigaionBackImage=_navigaionBackImage;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        navigationBack = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height-statusBack.frame.size.height)];
...
{
    [_delegate leftButtonClickEvent];
}

...
-(void)collectButtonEvent:(UIButton *)btn
{
    ...
    {
        //取消收藏
        BOOL isFinish = [[DBManager shareManager] deleteToTable:_FMSingerModel];
        if (isFinish) {
            _isFav = NO;
        }
    ...
    {
        //收藏
        BOOL isFinish = [[DBManager shareManager] insertToTable:_FMSingerModel];
        _isFav = isFinish;
        [btn setImage:[UIImage imageNamed:@"collected"] forState:UIControlStateNormal];
    }
}

...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (self.contentOffset.x == 0) {
        currentImageNum = (currentImageNum-1)%_imageNameArray.count;
    ...
    _leftImageView.image = [UIImage imageNamed:_imageNameArray[(currentImageNum-1)%_imageNameArray.count]];
    
    
    _centerImageView.image = [UIImage imageNamed:_imageNameArray[currentImageNum%_imageNameArray.count]];
    
    
    _rightImageView.image = [UIImage imageNamed:_imageNameArray[(currentImageNum+1)%_imageNameArray.count]];
